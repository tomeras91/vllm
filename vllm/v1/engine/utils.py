...
class EngineZmqAddresses:
    ...
    def pop_held_ports(
        ...
        self._held_input_sockets: list[stdlib_socket.socket] = []
        self._held_output_sockets: list[stdlib_socket.socket] = []
...
def _get_tcp_socket_family(host: str) -> int:
    ...
    for family, socktype, _, _, _ in addrinfos:
        if socktype == stdlib_socket.SOCK_STREAM and family in (
            stdlib_socket.AF_INET,
            stdlib_socket.AF_INET6,
        ):
            return family
